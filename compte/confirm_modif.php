...
$req = $db->prepare('UPDATE objet_annonce SET titre=:titre, Instants_de_consommation=:Instants_de_consommation, description=:description, ambiance=:ambiance, composante_du_repas=:composante_du_repas, prise_de_vue=:prise_de_vue, region=:region, date=:date WHERE id=:num LIMIT 1');

$req->bindValue(':num',$_POST['IDtable'],PDO::PARAM_INT);
$req->bindValue(':titre', $_POST['titre'],PDO::PARAM_STR);
$req->bindValue(':Instants_de_consommation', $_POST['Instants_de_consommation'],PDO::PARAM_STR);
$req->bindValue(':description', $_POST['description'],PDO::PARAM_STR);
$req->bindValue(':ambiance', $_POST['ambiance'],PDO::PARAM_STR);
$req->bindValue(':composante_du_repas', $_POST['composante_du_repas'],PDO::PARAM_STR);
$req->bindValue(':prise_de_vue', $_POST['prise_de_vue'],PDO::PARAM_STR);
$req->bindValue(':region', $_POST['region'],PDO::PARAM_STR);
